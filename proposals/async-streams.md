...
foreach async (var i in GetData())
{
...
...
foreach async (T i in GetData(ct))
{
    ...
}
```
...
```C#
var enumerable = ...;
foreach async (T item in enumerable)
{
   ...
}
```
...
```C#
foreach async (T item in enumerable.ConfigureAwait(false))
{
   ...
}
```
