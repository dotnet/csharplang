...
* If we silently change resolution, encounter potentially different behavior between machines if one machine understands the attribute and another doesn't.
